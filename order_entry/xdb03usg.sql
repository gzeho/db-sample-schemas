...
--
@C:/app/dolatog/github_examples/db-sample-schema/order_entry/createFolders.sql


--
-- Load example documents into the XDB repository
--
@C:/app/dolatog/github_examples/db-sample-schema/order_entry/createResources.sql
