...
CREATE OR REPLACE DIRECTORY data_file_dir AS 'C:/app/dolatog/github_examples/db-sample-schema/sales_history/'; 
CREATE OR REPLACE DIRECTORY log_file_dir  AS 'C:/app/dolatog/github_examples/db-sample-schema/log/'; 
CREATE OR REPLACE DIRECTORY media_dir     AS 'C:/app/dolatog/github_examples/db-sample-schema/product_media/';
