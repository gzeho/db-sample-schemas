...
@C:/app/dolatog/github_examples/db-sample-schema/mk_dir
...
@C:/app/dolatog/github_examples/db-sample-schema/human_resources/hr_code
...
@C:/app/dolatog/github_examples/db-sample-schema/order_entry/oe_main.sql &&password_oe EXAMPLE TEMP  &&password_hr &&password_sys &&oe_data_path &&log_path &vrs
...
@C:/app/dolatog/github_examples/db-sample-schema/bus_intelligence/bi_views.sql &&password_bi
...
connect oe/&&password_oe;
@C:/app/dolatog/github_examples/db-sample-schema/order_entry/oe_analz
connect pm/&&password_pm;
@C:/app/dolatog/github_examples/db-sample-schema/product_media/pm_analz
connect hr/&&password_hr;
@C:/app/dolatog/github_examples/db-sample-schema/human_resources/hr_analz
connect sh/&&password_sh
@C:/app/dolatog/github_examples/db-sample-schema/sales_history/sh_analz
