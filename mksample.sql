...
@C:/app/dolatog/github_examples/db-sample-schema/human_resources/hr_main.sql &&password_hr &&default_ts &&temp_ts &&password_sys &&logfile_dir &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@C:/app/dolatog/github_examples/db-sample-schema/order_entry/oe_main.sql &&password_oe &&default_ts &&temp_ts &&password_hr &&password_sys C:/app/dolatog/github_examples/db-sample-schema/order_entry/ &&logfile_dir &vrs &&connect_string

CONNECT system/&&password_system@&&connect_string

SET SHOWMODE OFF

@C:/app/dolatog/github_examples/db-sample-schema/product_media/pm_main.sql &&password_pm &&default_ts &&temp_ts &&password_oe &&password_sys C:/app/dolatog/github_examples/db-sample-schema/product_media/ &&logfile_dir C:/app/dolatog/github_examples/db-sample-schema/product_media/ &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@C:/app/dolatog/github_examples/db-sample-schema/info_exchange/ix_main.sql &&password_ix &&default_ts &&temp_ts &&password_sys &&logfile_dir &vrs &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@C:/app/dolatog/github_examples/db-sample-schema/sales_history/sh_main &&password_sh &&default_ts &&temp_ts &&password_sys C:/app/dolatog/github_examples/db-sample-schema/sales_history/ &&logfile_dir &vrs &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@C:/app/dolatog/github_examples/db-sample-schema/bus_intelligence/bi_main &&password_bi &&default_ts &&temp_ts &&password_sys &&password_oe &&password_sh &&logfile_dir &vrs &&connect_string
...
@C:/app/dolatog/github_examples/db-sample-schema/mkverify &&password_system &veri_spool &&connect_string
