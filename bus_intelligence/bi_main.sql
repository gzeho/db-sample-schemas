...
@C:/app/dolatog/github_examples/db-sample-schema/bus_intelligence/bi_oe_pr.sql &pwd_oe &connect_string
...
@C:/app/dolatog/github_examples/db-sample-schema/bus_intelligence/bi_sh_pr.sql &pwd_sh &connect_string

REM =======================================================
REM  Views and synonyms in the 10i BI schema
REM =======================================================

@C:/app/dolatog/github_examples/db-sample-schema/bus_intelligence/bi_views.sql &pwd_bi &connect_string
